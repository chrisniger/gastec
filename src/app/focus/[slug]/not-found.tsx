      ...
      <div className="relative container-gastec text-center px-4">
        ...
        >
          ...
          <p className="text-brand-grey max-w-lg mx-auto mb-8">
            ...
            Please check the URL or navigate back to explore our services.
          </p>

          {/* Breadcrumb */}
          <nav className="flex items-center justify-center gap-2 text-sm text-brand-grey mb-8" aria-label="Breadcrumb">
